...
de distribuci\'{o}n binomial es $\phi=\log\left(\frac{\theta}{1-\theta}\right)$.
Por otro lado, usando el principio de invanrianza de Jeffrey $p\left(\phi\right)=p\left(\theta\right)\left|\frac{d\theta}{d\phi}\right|$
si es que $\phi$ es una funci\'{o}n uno a uno. La demostraci\'{o}n
es bastante simple porque es b\'{a}sicamente transformaci\'{o}n de
...
\end{align*}
pero podemos usar astutamente la regla de la cadena de tal manera
que sea m\'{a}s pr\'{a}ctico para nosotros 
\begin{align*}
